...
pub trait TransactionNeighborThing{
    ...
    fn new<R>(_: &Vec<PlaceholderTruckNameThing>, rng: &mut R) -> Self where R:Rng + ?Sized;
...
pub struct Swap2RandomIndicesInSameRoute {
    truck: usize,
    day: usize,
    route_of_day: usize,
    index1: NodeIndex,
...
impl TransactionNeighborThing for Swap2RandomIndicesInSameRoute {

    fn new<R>(trucks: &Vec<PlaceholderTruckNameThing>, rng: &mut R) -> Self where R:Rng + ?Sized{
